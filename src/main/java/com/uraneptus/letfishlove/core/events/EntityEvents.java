...
public class EntityEvents {
    ...
    //TODO somewhere make fish follow fish food
    @SubscribeEvent
    ...
    public static void onEntityTick(LivingEvent.LivingTickEvent event) {
        ...
        if (entity instanceof AbstractFish fish) {
            ...
            AbstractFishCap.getCapOptional(fish).ifPresent(cap -> {
                System.out.println(cap.isInLove());
                System.out.println(cap.getLoveCause(level));
            });
        }
    }
    ...
    public static void onEntityJoin(EntityJoinLevelEvent event) {
        //TODO Here add goal for looking for mate partner & for laying roe
    }
}
